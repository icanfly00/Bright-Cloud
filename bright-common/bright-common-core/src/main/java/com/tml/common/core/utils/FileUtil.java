...
public class FileUtil {
    ...
    public static void download(String filePath, String fileName, Boolean delete, HttpServletResponse response) throws Exception {
        ...
        response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment;fileName=" + java.net.URLEncoder.encode(fileName, BrightConstant.UTF8));
        response.setContentType(MediaType.MULTIPART_FORM_DATA_VALUE);
        response.setCharacterEncoding(BrightConstant.UTF8);
    ...
    /**
     * 校验文件类型是否是允许下载的类型
     * （出于安全考虑：https://github.com/wuyouzhuguli/Bright-Shiro/issues/40）
     *
    ...
    private static Boolean fileTypeIsValid(String fileType) {
        ...
        return ArrayUtils.contains(BrightConstant.VALID_FILE_TYPE, fileType);
    }
