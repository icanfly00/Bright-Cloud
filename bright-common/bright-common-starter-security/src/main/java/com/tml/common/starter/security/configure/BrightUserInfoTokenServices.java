 ...
 */
public class BrightUserInfoTokenServices implements ResourceServerTokenServices {
    ...
    public BrightUserInfoTokenServices(String userInfoEndpointUrl, String clientId) {
