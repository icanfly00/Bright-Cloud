package com.tml.server.job.configure;
...
public class BrightJobConfigure {
    ...
    public ThreadPoolTaskExecutor scheduleJobExecutorService() {
        ...
        executor.setThreadNamePrefix("Bright-Job-Thread");
    ...
    public SchedulerFactoryBean schedulerFactoryBean() {
        ...
        prop.put(StdSchedulerFactory.PROP_SCHED_INSTANCE_NAME, "BrightCloudScheduler");
        ...
        factory.setSchedulerName("BRIGHT_Cloud_Scheduler");
        // 延时启动
