...
public class RequestMappingScan implements ApplicationListener<ApplicationReadyEvent> {
   ...
   @Resource
   private RabbitTemplate rabbitTemplate;//消息发送管道
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        ...
        threadPool.execute(() ->{
            ...
            rabbitTemplate.convertAndSend(QueueConstant.QUEUE_SCAN_API_RESOURCE_EXCHANGE,QueueConstant.QUEUE_SCAN_API_RESOURCE_KEY,JacksonUtil.toJson(resource),correlationId);
                });
    }
