 ...
 */
@Slf4j
public class BrightGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public BrightGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
